...
import ru.academits.polyanskaya.comparator.AreaPerimeterComparator;
...
public class ShapeMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Фигура с максимальной площадью - " + AreaPerimeterComparator.getShapeMaxArea(shapesArray));
        System.out.println("Фигура со вторым по величине периметром - " + AreaPerimeterComparator.getShapePreviousMaxPerimeter(shapesArray));
